...
interface AdminPanelScreenProps {
  ...
  onManageUsers: () => void;
  onManageEvents: () => void;
  onManageTournaments: () => void; // Mantido para compatibilidade, mas não será usado
  onManageQueue: () => void;
  onManageCoaches: () => void;
  onManageCompetitions: () => void; // Mantido para compatibilidade, mas não será usado
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-purple-900 text-white p-4 pt-16 pb-20">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            <h3 className="text-2xl font-semibold text-cyan-400 mb-3">Gerenciar Eventos</h3>
            <p className="text-gray-300">Crie, edite ou remova eventos e configure suas propriedades.</p>
          </div>
          ...
          {/* Funcionalidades de Torneios e Competições foram removidas para priorizar Queue e Event */}
          ...
          >
            <h3 className="text-2xl font-semibold text-cyan-400 mb-3">Gerenciar Fila</h3>
            <p className="text-gray-300">Visualize e controle a fila de músicas e participantes.</p>
          </div>

          {/* Gerenciamento de Coaches */}
          <div
            className="bg-gray-800 p-6 rounded-lg shadow-lg border border-purple-700 cursor-pointer transform transition-transform duration-300 hover:scale-105"
            onClick={onManageCoaches}
          >
            <h3 className="text-2xl font-semibold text-cyan-400 mb-3">Gerenciar Coaches</h3>
            <p className="text-gray-300">Adicione e edite coaches para as músicas disponíveis.</p>
          </div>
          ...
          >
            <h3 className="text-2xl font-semibold text-cyan-400 mb-3">Configurar Módulos</h3>
            <p className="text-gray-300">Configure os módulos do sistema e suas funcionalidades.</p>
          </div>
        </div>
      </div>
    </div>
